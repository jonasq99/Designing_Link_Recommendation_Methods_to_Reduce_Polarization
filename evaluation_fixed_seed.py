...
def evaluate_graph_modifications(G, seeds, k, max_iter, budget, verbose=True):
    ...
    original_results_dict = simulate_diffusion_ICM(G, seeds, max_iter, verbose)
    ...
    for method_name, mod_func in modification_functions.items():
        ...
        modified_results_dict = simulate_diffusion_ICM(
